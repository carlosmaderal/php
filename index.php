...
<html lang="pt-br">
  <head>
    ...
    <link rel="icon" href="suporte/imagens/favicon.ico">

    <title>Area Restrita</title>
    <link href="suporte/css/bootstrap.css" rel="stylesheet">
    <link href="suporte/css/ie10-viewport-bug-workaround.css" rel="stylesheet">
    <link href="suporte/css/signin.css" rel="stylesheet">
    <script src="suporte/js/ie-emulation-modes-warning.js"></script>
  </head>
  ...
  echo $_SESSION['usuarioNiveisAcessoId'];
    ...
    <script src="suporte/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
